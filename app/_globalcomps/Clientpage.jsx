    ...
    >
      ...
      >
        ...
        <Multiplevaluesfield
          ...
          state={data.cpuClockSpeed}
          setState={setdata}
          statename={"cpuClockSpeed"}
        />
        <Standardinputfield
          titlename="Npu"
          value={data.npu}
      ...
      >
        <Multiplevaluesfield
          title="Rear Camera megapixels"
          state={data.RearCameramegapixels}
          setState={setdata}
          statename={"RearCameramegapixels"}
        />
        <Multiplevaluesfield
          title="Front Camera megapixels"
          state={data.frontCameramegapixels}
          setState={setdata}
          statename={"frontCameramegapixels"}
        />
