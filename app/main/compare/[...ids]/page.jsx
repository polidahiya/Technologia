      ...
      <div className="max-w-6xl mx-auto space-y-2">
        ...
        <CompareSpecTable
          ...
          rows={[
            ...
            { label: "Refresh Rate", key: "display.0.refreshRate", unit: "Hz" },
            { label: "HDR", key: "display.0.hdr", type: "boolean" },
            { label: "Brightness", key: "display.0.Brightness", unit: "nits" },
            {
        ...
        <CompareSpecTable
          ...
          rows={[
            ...
            { label: "Headphone Jack", key: "headphoneJack", type: "boolean" },
          ]}
        />
