...
export const filters = {
  Price: {
    ...
    options: {
      below10k: {
        name: "Below ₹10,000",
        operation: (p) => p?.price.some((a) => (a.sp || a.mrp) <= 10000),
      },
      "10to15k": {
        name: "₹10,000 – ₹15,000",
        operation: (p) =>
          p?.price.some(
            (a) => (a.sp || a.mrp) >= 10000 && (a.sp || a.mrp) <= 15000
          ),
      },
      "15to20k": {
        name: "₹15,000 – ₹20,000",
        operation: (p) =>
          p?.price.some(
            (a) => (a.sp || a.mrp) >= 15000 && (a.sp || a.mrp) <= 20000
          ),
      },
      "20to30k": {
        name: "₹20,000 – ₹30,000",
        operation: (p) =>
          p?.price.some(
            (a) => (a.sp || a.mrp) >= 20000 && (a.sp || a.mrp) <= 30000
          ),
      },
      "30to40k": {
        name: "₹30,000 – ₹40,000",
        operation: (p) =>
          p?.price.some(
            (a) => (a.sp || a.mrp) >= 30000 && (a.sp || a.mrp) <= 40000
          ),
      },
      "40to60k": {
        name: "₹40,000 – ₹60,000",
        operation: (p) =>
          p?.price.some(
            (a) => (a.sp || a.mrp) >= 40000 && (a.sp || a.mrp) <= 60000
          ),
      },
      above60k: {
        name: "Above ₹60,000",
        operation: (p) => p?.price.some((a) => (a.sp || a.mrp) >= 60000),
      },
    },
  },
  Device: {
